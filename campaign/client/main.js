        ...
        <ul>
          ...
          <li>In server/main.js:
            <ul>
              ...
              <li>Assign the allowAllOperations to Thoughts_Collection_Access (this will allow unrestricted operations on the collection, which is fine for a learning exercise, but in a production app, you would want to control what operations users can perform (e.g., insert, update, remove))</li>
            </ul>
          </li>
